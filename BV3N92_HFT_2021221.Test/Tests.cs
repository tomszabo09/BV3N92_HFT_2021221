...
namespace BV3N92_HFT_2021221.Test
{
    ...
    public class Tests
    {
        ...
        {
            Assert.That(this.parliamentLogic.GetAllRulingParties().ToList().Count.Equals(4));
        }
        ...
        {
            Assert.That(this.partyLogic.GetJuniorMembers(1).ToList().Count.Equals(2));
        }

        [Test]
        public void GetSeniorMembersIsCorrect()
        {
            Assert.That(this.partyLogic.GetJuniorMembers(6).ToList().Count.Equals(1));
        }
        ...
        private IQueryable<Parliament> FakeParliamentObjects()
        {
            ...
            PartyMember pm1 = new PartyMember() { MemberID = 1, LastName = "TestMember1", Age = 20, PartyID = pt1.PartyID };
            PartyMember pm2 = new PartyMember() { MemberID = 2, LastName = "TestMember2", Age = 25, PartyID = pt1.PartyID };
            PartyMember pm3 = new PartyMember() { MemberID = 3, LastName = "TestMember3", Age = 30, PartyID = pt2.PartyID };
            PartyMember pm4 = new PartyMember() { MemberID = 4, LastName = "TestMember4", Age = 35, PartyID = pt2.PartyID };
            PartyMember pm5 = new PartyMember() { MemberID = 5, LastName = "TestMember5", Age = 40, PartyID = pt3.PartyID };
            PartyMember pm6 = new PartyMember() { MemberID = 6, LastName = "TestMember6", Age = 45, PartyID = pt3.PartyID };
            PartyMember pm7 = new PartyMember() { MemberID = 7, LastName = "TestMember7", Age = 50, PartyID = pt4.PartyID };
            PartyMember pm8 = new PartyMember() { MemberID = 8, LastName = "TestMember8", Age = 55, PartyID = pt4.PartyID };
            PartyMember pm9 = new PartyMember() { MemberID = 9, LastName = "TestMember9", Age = 60, PartyID = pt5.PartyID };
            PartyMember pm10 = new PartyMember() { MemberID = 10, LastName = "TestMember10", Age = 65, PartyID = pt5.PartyID };
            PartyMember pm11 = new PartyMember() { MemberID = 11, LastName = "TestMember11", Age = 70, PartyID = pt6.PartyID };
            PartyMember pm12 = new PartyMember() { MemberID = 12, LastName = "TestMember12", Age = 23, PartyID = pt6.PartyID };
